package com.tyunin.metrics.config;
...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, LogEntry> consumerFactory() {
		...
		properties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, LogEntry.class);
	...
	public ConcurrentKafkaListenerContainerFactory<String, LogEntry> kafkaListenerContainerFactory() {
		var factory = new ConcurrentKafkaListenerContainerFactory<String, LogEntry>();
