...
public class CorsConfig {
	...
	public CorsFilter corsFilter() {
		...
		config.addAllowedOrigin(String.format("http://localhost:8080,http://127.0.0.1:8080,%s:%s,%s:%s,%s:%s", backendBaseUrl, backendPort, ssoBaseUrl, ssoPort, frontedBaseUrl, frontedPort));
